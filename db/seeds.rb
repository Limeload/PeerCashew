...
investor1 = Investor.create(user: user10, investment_amount: 1000, interest_rate: 4.00, status: 'Active')
investor2 = Investor.create(user: user9, investment_amount: 5000, interest_rate: 6.50, status: 'Pending')
investor3 = Investor.create(user: user8, investment_amount: 3500, interest_rate: 4.50, status: 'Closed')
